...
class AlimentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alimento" do
    assert_difference("Alimento.count") do
      post alimentos_url, params: { alimento: { description: @alimento.description, name: @alimento.name, quantity: @alimento.quantity } }
    end
  ...
  test "should update alimento" do
    patch alimento_url(@alimento), params: { alimento: { description: @alimento.description, name: @alimento.name, quantity: @alimento.quantity } }
