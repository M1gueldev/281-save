...
class AlmacensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create almacen" do
    assert_difference("Almacen.count") do
      post almacens_url, params: { almacen: { description: @almacen.description, location: @almacen.location, name: @almacen.name } }
    end
  ...
  test "should update almacen" do
    patch almacen_url(@almacen), params: { almacen: { description: @almacen.description, location: @almacen.location, name: @almacen.name } }
