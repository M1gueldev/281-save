...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference("Producto.count") do
      post productos_url, params: { producto: { description: @producto.description, name: @producto.name, quantity: @producto.quantity } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { description: @producto.description, name: @producto.name, quantity: @producto.quantity } }
