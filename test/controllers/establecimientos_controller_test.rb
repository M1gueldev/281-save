...
class EstablecimientosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create establecimiento" do
    assert_difference("Establecimiento.count") do
      post establecimientos_url, params: { establecimiento: { description: @establecimiento.description, location: @establecimiento.location, name: @establecimiento.name } }
    end
  ...
  test "should update establecimiento" do
    patch establecimiento_url(@establecimiento), params: { establecimiento: { description: @establecimiento.description, location: @establecimiento.location, name: @establecimiento.name } }
