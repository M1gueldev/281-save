...
class InventariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventario" do
    assert_difference("Inventario.count") do
      post inventarios_url, params: { inventario: { cantidad: @inventario.cantidad, elementos: @inventario.elementos, fecha: @inventario.fecha, ubicacion: @inventario.ubicacion } }
    end
  ...
  test "should update inventario" do
    patch inventario_url(@inventario), params: { inventario: { cantidad: @inventario.cantidad, elementos: @inventario.elementos, fecha: @inventario.fecha, ubicacion: @inventario.ubicacion } }
