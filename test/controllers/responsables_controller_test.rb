...
class ResponsablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsable" do
    assert_difference("Responsable.count") do
      post responsables_url, params: { responsable: { address: @responsable.address, email: @responsable.email, identification: @responsable.identification, name: @responsable.name, phone: @responsable.phone } }
    end
  ...
  test "should update responsable" do
    patch responsable_url(@responsable), params: { responsable: { address: @responsable.address, email: @responsable.email, identification: @responsable.identification, name: @responsable.name, phone: @responsable.phone } }
