class EstablecimientosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @establecimiento.save
        format.html { redirect_to establecimiento_url(@establecimiento), notice: "Establecimiento was successfully created." }
  ...
  def update
    respond_to do |format|
      if @establecimiento.update(establecimiento_params)
        format.html { redirect_to establecimiento_url(@establecimiento), notice: "Establecimiento was successfully updated." }
  ...
  private
    ...
    def establecimiento_params
      params.require(:establecimiento).permit(:name, :description, :location)
    end
end
