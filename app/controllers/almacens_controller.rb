class AlmacensController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @almacen.save
        format.html { redirect_to almacen_url(@almacen), notice: "Almacen was successfully created." }
  ...
  def update
    respond_to do |format|
      if @almacen.update(almacen_params)
        format.html { redirect_to almacen_url(@almacen), notice: "Almacen was successfully updated." }
  ...
  private
    ...
    def almacen_params
      params.require(:almacen).permit(:name, :description, :location)
    end
end
